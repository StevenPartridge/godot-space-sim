...
@onready var max_speed_value = $max_speed/MaxSpeedValue
@onready var acceleration_value = $acceleration/AccelerationValue
@onready var pitch_speed_value = $pitch_speed/PitchSpeedValue
@onready var roll_speed_value = $roll_speed/RollSpeedValue
@onready var input_response_value = $input_response/InputResponseValue
